...
namespace TwoWeekControl.iOS
{
    ...
    {
        //
        // This method is invoked when the application has loaded and is
        // ready to run. In this method you should instantiate the window,
